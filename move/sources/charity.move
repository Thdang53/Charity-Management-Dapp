module charity::charity_platform {
    ...
    public entry fun create_campaign(
        ...
        // ⚠️ Share campaign object để mọi người có thể donate
        // Đây là điểm quan trọng: Campaign phải là SHARED OBJECT
    ...
    /// Get campaign ID at index
    public fun get_campaign_id_at(registry: &CampaignRegistry, index: u64): ID {
        *vector::borrow(&registry.campaigns, index)
    }
    
    /// Get all campaign IDs
    public fun get_all_campaign_ids(registry: &CampaignRegistry): vector<ID> {
        registry.campaigns
    }
